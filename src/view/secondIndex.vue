<template>
  ...
  <!-- 内容开始 -->
    <div class="content clear">
          <div class="detail_box" v-for="item in detail">
...
export default {
  ...
  mounted: function() {
    var self=this;
    self.address=localStorage.address
    http(api.tabload.method, api.tabload.url,{category_id:self.$route.query.id,page:self.page,local:localStorage.address},function(data){
        console.log(data)
